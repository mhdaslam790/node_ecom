...
class ProductRepository {
    ...
    getProductById(productId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield (0, database_1.executeSql)(query, [productId]);
            if (result.length > 0) {
                return result[0];
            }
            else {
    ...
    add() {
        return __awaiter(this, void 0, void 0, function* () {
            const insertQuery = `INSERT INTO Product (image, name, description, unit, currency, dealOfTheDay,
            topProducts, onSale, currentPrice , actualPrice, quantityPerUnit, isProductAvailable,productId)
            VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
